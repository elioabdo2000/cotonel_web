...
export default function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed z-40 flex h-13 w-13 items-center justify-center rounded-full bg-[var(--color-whatsapp)] text-cream-raised shadow-[0_10px_30px_-12px_rgba(47,42,32,0.45)] transition hover:brightness-110 sm:h-14 sm:w-14"
      style={{
